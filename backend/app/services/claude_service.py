...
class ClaudeService:
    ...
    async def get_maintenance_recommendations(self, vehicle: Vehicle, maintenance_records: List[Maintenance]) -> Tuple[str, str, str]:
...
5. Model-Specific Recommendations: Include any known issues or special considerations for this specific {vehicle.year} {vehicle.brand} {vehicle.model}, including common problems, recalls, or preventive measures that can help avoid known issues with this model.
